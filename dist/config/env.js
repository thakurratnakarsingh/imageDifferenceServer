...
const schema = zod_1.z.object({
    ...
    DB_PASSWORD: zod_1.z.string().default('StrongPassword123!'),
    JWT_SECRET: zod_1.z.string().min(16).default('development-secret-change-me'),
    JWT_EXPIRES_IN: zod_1.z.string().default('7d'),
    BASE_URL: zod_1.z.string().url().default('http://13.60.169.242:5000'),
    ADMIN_ORIGIN: zod_1.z.string().default('http://13.60.169.242,http://13.60.169.242:5000,http://13.60.169.242:5173'),
