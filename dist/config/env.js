...
const schema = zod_1.z.object({
    ...
    BASE_URL: zod_1.z.string().url().default('http://13.53.133.200:5000'),
    ADMIN_ORIGIN: zod_1.z.string().default('http://13.53.133.200,http://13.53.133.200:5000,http://13.53.133.200:5173'),
